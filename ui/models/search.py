...
class SearchResult(BaseModel):
    snippet: str = Field(description="Snippet of the search item")
    title: str = Field(description="Title of the search item")
    link: str = Field(description="URL of the search item")
    date: datetime = Field(description="Publication date of the search item")
